...
function setupNativeMediaBridge() {
  if (!nativeMedia) return;
  // Desde Android 13 (API 33), publicar CUALQUIER notificación —incluida la
  // del servicio en primer plano que mantiene viva la reproducción— exige
  // que la propia app pida antes el permiso POST_NOTIFICATIONS en tiempo de
